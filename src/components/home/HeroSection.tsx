          ...
          <div className="relative hidden lg:block animate-fade-up" style={{ animationDelay: "0.3s" }}>
            <div className="relative">
              ...
              <div className="bg-card/90 backdrop-blur-xl rounded-3xl p-6 shadow-2xl border border-accent-foreground/10">
                <div className="aspect-video bg-gradient-to-br from-muted to-muted/50 rounded-2xl mb-4 flex items-center justify-center overflow-hidden">
                  <div className="w-16 h-16 rounded-full gradient-accent flex items-center justify-center shadow-glow cursor-pointer hover:scale-110 transition-transform">
