...
import { BookOpen, Clock, Award, TrendingUp, PlayCircle, Calendar, Bell, Settings, ChevronRight, Star, } from "lucide-react";
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              ...
              <div className="grid md:grid-cols-3 gap-4">
                {achievements.map((achievement) => (<Card key={achievement.name}>
