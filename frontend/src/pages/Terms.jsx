        ...
        <div className="min-h-screen bg-background pt-20">
            <div className="container mx-auto px-4 py-8 max-w-4xl">
                ...
                <div className="prose prose-neutral dark:prose-invert max-w-none">
                    ...
                    <p>Please read these Terms of Service carefully before using the Qurio website.</p>
                    ...
                    <p>The service and its original content, features, and functionality are and will remain the exclusive property of Qurio and its licensors.</p>
