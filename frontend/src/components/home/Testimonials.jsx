            ...
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                {user && testimonial.userId === user.id && (
                  <>
                    <div className="absolute top-4 right-4 flex gap-2 z-10 bg-background/40 backdrop-blur-md p-1 rounded-full border border-white/10">
                      <button
                        onClick={() => handleEdit(testimonial)}
                        className="p-1.5 hover:bg-accent text-white/70 hover:text-white rounded-full transition-colors"
                        title="Edit"
                      >
                      ...
                      <button
                        ...
                        className="p-1.5 hover:bg-destructive text-white/70 hover:text-white rounded-full transition-colors"
                        title="Delete"
                      >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      {user && testimonial.userId === user.id && (
                        <span className="text-[10px] bg-accent/20 text-accent border border-accent/30 px-2 py-0.5 rounded-full uppercase tracking-wider font-semibold">
                          You
                        </span>
                      )}
                    </div>
