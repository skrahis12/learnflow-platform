import { PlayCircle, Award, Users, Zap, Shield, Clock } from "lucide-react";
const features = [
  {
    icon: PlayCircle,
  ...
  return (<section className="py-20 lg:py-28 bg-background">
    <div className="container mx-auto px-4">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {features.map((feature, index) => (<div key={feature.title} className="group relative bg-card rounded-2xl p-8 border border-border hover:border-accent/30 transition-all duration-300 hover:shadow-xl animate-fade-up" style={{ animationDelay: `${index * 0.1}s` }}>
